  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <ConfirmDeleteModal
        ...
        description={
          <>
            Estás a punto de eliminar <span className="text-foreground font-bold">"{currentProject?.name}"</span>. 
            Esta acción borrará permanentemente todas las palabras clave y el historial de rankings asociado.
          </>
        }
        confirmText="Sí, eliminar proyecto"
        loadingText="Eliminando proyecto..."
      />
      ...
      <ConfirmDeleteModal
        ...
        description={
          <>
            ¿Estás seguro de eliminar <span className="text-foreground font-bold">"{keywordToDelete?.keyword}"</span>? 
            Se borrará todo el historial de posiciones de esta palabra clave.
          </>
        }
        confirmText="Sí, eliminar palabra clave"
