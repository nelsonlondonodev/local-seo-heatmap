...
/**
 * Component for AI Review Reply Generation.
 */
          ...
          <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-500">
            <div className="rounded-xl border-2 border-primary/10 bg-background/80 p-5 relative group">
              ...
              <div className="flex gap-3 pt-4 border-t border-primary/5">
                <Button 
                  variant="outline" 
                  size="sm" 
                  className="flex-1 rounded-lg gap-2 font-bold"
                  onClick={handleCopy}
                >
                ...
                <Button 
                  variant="ghost" 
                  size="sm" 
                  className="rounded-lg gap-2 text-muted-foreground hover:text-primary transition-colors font-bold"
                  onClick={reset}
                >
            ...
            <div className="bg-blue-500/5 rounded-lg p-3 border border-blue-500/10 flex items-start gap-3">
              ...
              <p className="text-[11px] text-blue-700/80 leading-tight">
                <strong>Consejo de Reputación:</strong> Responder a todas las reseñas (especialmente las negativas) demuestra compromiso con tus clientes y mejora el posicionamiento SEO local de tu negocio.
              </p>
            </div>
          </div>
        )}
