...
import { HeatmapMap, useHeatmap, BusinessSearch, ScanProgress, HeatmapLegend, type PlaceSuggestion } from '@/features/heatmap';
          ...
          <Card>
            ...
            <CardContent className="space-y-5">
              ...
              <div className="flex items-center justify-between px-1 py-1">
                ...
                <div className="flex items-center gap-1 bg-primary/10 text-primary px-2.5 py-1 rounded-full border border-primary/20 shadow-sm">
                  <span className="text-xs font-bold">{heatmap.estimatedCost}</span>
                  <span className="text-[10px] uppercase font-black opacity-80">créditos</span>
                </div>
              </div>
