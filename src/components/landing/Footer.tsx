...
function FooterColumn({ title, links }: FooterColumnProps) {
  return (
    <div className="space-y-4">
      <h5 className="font-semibold uppercase text-[10px] tracking-widest text-zinc-400">{title}</h5>
...
function SocialLink({ href, label, icon }: { href: string; label: string; icon: React.ReactNode }) {
  return (
    <a href={href} className="text-zinc-600 hover:text-zinc-400 transition-colors">
