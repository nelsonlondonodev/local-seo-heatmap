...
export function Footer() {
  ...
  return (
    <footer className="py-24 border-t border-zinc-900 bg-zinc-950">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-20">
          ...
          <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-10">
            <div className="space-y-4">
              <h5 className="font-semibold uppercase text-[10px] tracking-widest text-zinc-400">Producto</h5>
              <ul className="space-y-3 text-sm font-medium text-zinc-500">
                <li><a href="#features" className="hover:text-white transition-colors">Heatmaps</a></li>
                <li><a href="#features" className="hover:text-white transition-colors">Keywords</a></li>
                <li><a href="#pricing" className="hover:text-white transition-colors">Pricing</a></li>
              </ul>
            </div>
            <div className="space-y-4">
              <h5 className="font-semibold uppercase text-[10px] tracking-widest text-zinc-400">Soporte</h5>
              <ul className="space-y-3 text-sm font-medium text-zinc-500">
            ...
            <div className="space-y-4">
              <h5 className="font-semibold uppercase text-[10px] tracking-widest text-zinc-400">Legal</h5>
              <ul className="space-y-3 text-sm font-medium text-zinc-500">
